...
def main():
    ...
    parser.add_argument('-v', action='count', default=0, help='Enable verbose (takes up to -vvv)')
    parser.add_argument('-t', action='store', type=int, default=35, help='Threshold for vertical hist')
    parser.add_argument('-l', action='store', type=float, default=2.0, help='low weight for top trace')
    parser.add_argument('-y', action='store', type=float, default=0.4, help='high weight of top trace')
    parser.add_argument('-z', action='store', type=float, default=80, help='threshold for top trace (percentage)')
    ...
    parser.add_argument('-x', action='store', type=int, default=0, help='Override for testing (value is number of letters in word)')
